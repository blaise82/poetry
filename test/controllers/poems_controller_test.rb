...
class PoemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post poems_url, params: { poem: { author: @poem.author, poem: @poem.poem, title: @poem.title } }
    end
  ...
  test "should update poem" do
    patch poem_url(@poem), params: { poem: { author: @poem.author, poem: @poem.poem, title: @poem.title } }
